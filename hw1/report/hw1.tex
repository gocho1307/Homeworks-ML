...
\begin{enumerate}[leftmargin=\labelsep]
    ...
    Since the rank correlation (under Spearman coefficient) obtained a value close to 0, we can conclude that the variables $y_1$ and $y_2$ are almost non correlated.
